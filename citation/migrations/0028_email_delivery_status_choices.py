    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ("sent", "Author correspondence successfully sent"),
                    ("error", "Unable to send email, see error log for details"),
                    ("not_sent", "Correspondence has not been sent yet"),
                ],
                default="not_sent",
                max_length=50,
            ),
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(
                limit_choices_to=models.Q(
                    ...
                    (
                        "model__in",
                        ["author", "container", "platform", "publication", "sponsor"],
                    ),
                ),
