    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="A human readable representation of the change made",
                    ),
                ),
                (
                    "creator",
            ...
            fields=[
                ...
                (
                    ...
                    django.contrib.postgres.fields.jsonb.JSONField(
                        blank=True,
                        help_text="A JSON dictionary containing modified fields, if any, for the given publication",
                        null=True,
                    ),
                ),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        auto_now_add=True,
                        help_text="Date this model was imported into this system",
                    ),
                ),
                (
                    "date_modified",
                    models.DateTimeField(
                        auto_now=True,
                        help_text="Date this model was last modified on this system",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        auto_now_add=True,
                        help_text="Date this container was imported into this system",
                    ),
                ),
                (
                    "date_modified",
                    models.DateTimeField(
                        auto_now=True,
                        help_text="Date this container was last modified on this system",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="container_aliases",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="citation_added_by",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="citation_added_note_set",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "zotero_date_added",
                    models.DateTimeField(
                        blank=True, help_text="date added field from zotero", null=True
                    ),
                ),
                (
                    ...
                    models.DateTimeField(
                        blank=True,
                        help_text="date modified field from zotero",
                        null=True,
                    ),
                ),
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            (
                                "FLAGGED",
                                "Flagged for further internal review by CoMSES staff",
                            ),
                            (
                                "AUTHOR_UPDATED",
                                "Updated by author, needs CoMSES review",
                            ),
                            (
                                "INVALID",
                                "Publication record is not applicable or invalid",
                            ),
                            ("COMPLETE", "Reviewed and verified by CoMSES"),
                        ],
                        default="UNTAGGED",
                        max_length=32,
                    ),
                ...
                (
                    ...
                    models.DateTimeField(
                        auto_now_add=True,
                        help_text="Date this publication was imported into this system",
                    ),
                ),
                (
                    "date_modified",
                    models.DateTimeField(
                        auto_now=True,
                        help_text="Date this publication was last modified on this system",
                    ),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="citation_added_publication_set",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        blank=True,
                        help_text="Currently assigned curator",
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="publication_citations",
                        to="citation.Publication",
                    ),
                ),
            ],
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="citation.ModelDocumentation",
                    ),
                ),
                (
                    "publication",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="publications_platforms",
                        to="citation.Platform",
                    ),
                ),
                (
                    "publication",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="publication_platforms",
                        to="citation.Publication",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="publication_sponsors",
                        to="citation.Publication",
                    ),
                ),
            ],
                ...
                (
                    ...
                    models.TextField(
                        choices=[
                            ...
                            (
                                "CROSSREF_SEARCH_FAIL_NOT_UNIQUE",
                                "CrossRef search failed - not unique",
                            ),
                            (
                                "CROSSREF_SEARCH_FAIL_OTHER",
                                "CrossRef search failed - other",
                            ),
                            (
                                "CROSSREF_SEARCH_CANDIDATE",
                                "CrossRef search match candidate",
                            ),
                        ],
                        max_length=100,
                    ),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="raw", through="citation.RawAuthors", to="citation.Author"
            ),
        ),
        migrations.AddField(
            model_name="raw",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                through="citation.PublicationCitations",
                to="citation.Publication",
            ),
        ),
        migrations.AddField(
            ...
            name="container",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT, to="citation.Container"
            ),
        ),
        migrations.AddField(
            model_name="publication",
            ...
            field=models.ManyToManyField(
                ...
                through="citation.PublicationAuthors",
                to="citation.Author",
            ),
        ),
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True,
                related_name="publications",
                through="citation.PublicationModelDocumentations",
                to="citation.ModelDocumentation",
            ),
        ),
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True,
                related_name="publications",
                through="citation.PublicationPlatforms",
                to="citation.Platform",
            ),
        ),
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True,
                related_name="publications",
                through="citation.PublicationSponsors",
                to="citation.Sponsor",
            ),
        ),
        migrations.AddField(
            ...
            name="tags",
            field=models.ManyToManyField(
                blank=True, through="citation.PublicationTags", to="citation.Tag"
            ),
        ),
        migrations.AddField(
            model_name="note",
