...
def populate_categories(apps, schema_editor):
    ...
    for raw_category in CATEGORIES:
        code_archive_url_category = CodeArchiveUrlCategory(
            category=raw_category[0], subcategory=raw_category[1]
        )
    ...
    for raw_category, code_archive_url_category in zip(
        CATEGORIES, code_archive_url_categories
    ):
        raw_patterns = raw_category[2]
        for raw_pattern in raw_patterns:
            pattern = CodeArchiveUrlPattern(
                regex_host_matcher=raw_pattern[0],
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(
            code=populate_categories, reverse_code=unpopulate_categories
        )
    ]
